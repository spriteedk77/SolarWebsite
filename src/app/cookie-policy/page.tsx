...
export default function CookiePolicyPage() {
  return (
    <>
      ...
      >
        <p className="mt-6 text-caption text-navy-200">ปรับปรุงล่าสุด: {LAST_UPDATED}</p>
      </PageHero>
      ...
      <Section tone="white" width="narrow">
        <div className="prose-th">
          ...
          <p>
            ใช้เพื่อให้เว็บไซต์ทำงานได้อย่างถูกต้อง เช่น การจดจำตัวเลือกความยินยอมเรื่องคุกกี้ของคุณ
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>จดจำตัวเลือกความยินยอมเรื่องคุกกี้ของคุณ (เก็บในเบราว์เซอร์ของคุณเอง)</td>
          ...
          <p>
            ใช้เพื่อให้เราเข้าใจว่าผู้เข้าชมใช้งานเว็บไซต์อย่างไร หน้าใดมีประโยชน์
            และส่วนใดควรปรับปรุง <strong>คุกกี้ประเภทนี้จะทำงานก็ต่อเมื่อคุณให้ความยินยอมเท่านั้น</strong>{' '}
          ...
          <p>
            ...
            <strong>ทำงานก็ต่อเมื่อคุณให้ความยินยอมเท่านั้น</strong> เช่นเดียวกับคุกกี้เพื่อการวิเคราะห์
          </p>

          <Note tone="info" label="สถานะปัจจุบันของเว็บไซต์">
            ขณะนี้เว็บไซต์ยังไม่ได้ติดตั้งเครื่องมือวิเคราะห์หรือเครื่องมือโฆษณาใด ๆ
            หากมีการเพิ่มในอนาคต เครื่องมือเหล่านั้นจะถูกโหลดหลังจากได้รับความยินยอมของคุณเท่านั้น
        ...
        <div className="prose-th mt-12">
          <h2>ติดต่อเรา</h2>
          <p>
            หากมีคำถามเกี่ยวกับนโยบายนี้ ติดต่อได้ที่ {contact.phone} หรือ LINE {contact.lineId}{' '}
            รายละเอียดเรื่องข้อมูลส่วนบุคคลโดยรวมอยู่ที่{' '}
