...
export const alt = 'NP88 Solar — Solar Rooftop design and installation, Chiang Mai';
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ display: 'flex', gap: 10, fontSize: 40, fontWeight: 700 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          <div style={{ fontSize: 62, fontWeight: 700, color: '#ffffff', lineHeight: 1.2 }}>
            Engineering Your
          </div>
          <div style={{ fontSize: 62, fontWeight: 700, color: '#ffffff', lineHeight: 1.2 }}>
            Energy Future.
